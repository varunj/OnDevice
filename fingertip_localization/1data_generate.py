...
Path="/home/ramakrishna/Documents/kerasCodes/egofing_gaurav/testing/"					# for testing
#Path="/home/ramakrishna/Documents/kerasCodes/egofing_gaurav/txt/" 					# for training
Path2="/home/ramakrishna/Documents/kerasCodes/egofing_gaurav/testingcsv/" 				# for testing
#Path2="/home/ramakrishna/Documents/kerasCodes/egofing_gaurav/CSVlabels/" 				# for training
...
for filename in os.listdir(Path):
	   ...
	   for i in range(0,s):
		imfile=""
		c=0
		for k in data.ix[i,0]: 
		    if c==3: 
			imfile= imfile + k.upper()
			c=c+1 
		    else: 
			imfile = imfile + k
			c=c+1
		img = cv2.imread(Path1+imfile)	
